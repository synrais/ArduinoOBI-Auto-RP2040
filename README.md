...
Insert any Makita 18 V or 36 V LXT Li-Ion pack and within 2 seconds you get a full report:
...
- **ESP32-C3 / RP2040 Zero** — pull up to **3.3 V only**. These are 3.3 V-native devices and 5 V on a GPIO will damage them. Connect to Bus enable and 1-Wire data to your chip via 1k resistors to mitigate risk of a pin getting stuck high or low or blowing. (It helps alot!)
